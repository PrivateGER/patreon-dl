...
echo "Building Linux..."
GOOS=linux GOARCH=amd64 go build -o "build/patreon-dl_${VERSION}_Linux_amd64"
GOOS=linux GOARCH=386 go build -o "build/patreon-dl_${VERSION}_Linux_i386"

echo "Building Windows..."
GOOS=windows GOARCH=386 go build -o "build/patreon-dl_${VERSION}_Windows_x86_64.exe"
GOOS=windows GOARCH=386 go build -o "build/patreon-dl_${VERSION}_Windows_i386.exe"

echo "Building Darwin..."
GOOS=darwin GOARCH=amd64 go build -o "build/patreon-dl_${VERSION}_Darwin_x86_64"
GOOS=darwin GOARCH=arm64 go build -o "build/patreon-dl_${VERSION}_Darwin_ARM64"
